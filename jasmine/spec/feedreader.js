...
$(function() {
    ...
    */
    ...
    describe('The menu', function() {
        ...
        it('menu items visible when clicked', function() {
            let itemClicked = document.querySelector(".menu-icon-link");
            itemClicked.click();
    ...
    describe('Initial Entries', function() {
        ...
        it('at least single entry when loadFeed is called', function(done) {
            let feeds = document.querySelector(".feed");
            expect(feeds.querySelectorAll('.entry').length).toBeGreaterThan(0);
            done();
        });
    });
